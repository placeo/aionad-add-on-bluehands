...
object MediaUtils {
    ...
    fun readRawTextFile(context: Context, rawId: Int): String {
        ...
        try {
            ...
            e.printStackTrace()
            Timber.e("open raw file failed!", e)
        }
        try {
            br.close()
        } catch (e: IOException) {
            e.printStackTrace()
            Timber.e("close raw file failed!", e)
        }
        return sb.toString()
    }
    ...
    fun saveYuv2Jpeg(path: String, data: ByteArray, width: Int, height: Int): Boolean {
        val yuvImage = try {
            ...
            Timber.e("create YuvImage failed.", e)
            null
        } ?: return false
        ...
        var result = try {
            ...
            Timber.e("compressToJpeg failed.", e)
            false
        }
        if (! result) {
            return false
        ...
        try {
            ...
            Timber.e("saveYuv2Jpeg failed.", e)
            result = false
            e.printStackTrace()
        } finally {
            try {
