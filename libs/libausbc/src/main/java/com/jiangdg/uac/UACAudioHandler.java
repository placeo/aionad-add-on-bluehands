...
public class UACAudioHandler extends Handler {
    ...
    public void handleMessage(Message msg) {
        final AudioThread thread = mThreadWf.get();
        if (thread == null) {
            Timber.w("handleMessage: err, thread is null");
            return;
        }
        switch (msg.what) {
            case MSG_INIT:
    ...
    public static  class AudioThread extends Thread {
        ...
        public void handleInitAudioRecord() {
            ...
            Timber.i("handleInitAudioRecord");
        }

        public void handleStartRecording() {
            if (mUACAudio == null) {
                Timber.e("handleStartRecording failed, you should call initAudioRecord first");
                return;
            }
            mUACAudio.startRecording();
            Timber.i("handleStartRecording");
        }

        public void handleStopRecording() {
            if (mUACAudio == null) {
                Timber.e("handleStopRecording failed, you should call initAudioRecord first");
                return;
            }
            mUACAudio.stopRecording();
            Timber.i("handleStopRecording");
        }
        ...
        public void handleReleaseAudioRecord() {
            ...
            Timber.i("handleReleaseAudioRecord");
        }
        ...
        public void run() {
            ...
            try {
                ...
                Timber.e("UACAudioHandler new failed, " + e.getMessage());
            }
            if (uacHandler != null) {
                synchronized (mSync) {
            ...
            synchronized (mSync) {
                if (mUACHandler == null) {
                    try {
                        ...
                        Timber.e("getHandler: failed, " + e.getMessage());
                        e.printStackTrace();
                    }
                }
            }
